...
import com.zamanak.bluetoothlowenergy.models.BleGattCharacteristicListItem;
import com.zamanak.bluetoothlowenergy.models.BleGattServiceListItem;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.Map;

/**
 * the parent list items will represent services and the child list item will represent characteristic
 */
public class BleGattProfileListAdapter extends BaseExpandableListAdapter {
    ...
    public void addCharacteristic(BluetoothGattService service, BluetoothGattCharacteristic characteristic) throws Exception {
        ...
        if (serviceItemId < 0)
            throw new Exception("Service not found with UUID: " + service.getUuid().toString());
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            v = inflater.inflate(R.layout.list_item_ble_characterictic, null);
            // match the UI stuff in the list Item to what's in the xml file
        ...
        if (characteristicListItemView != null) {
            ...
            if (BlePeripheral.isCharacteristicReadable(characteristic)) {
                ...
                characteristicListItemView.mPropertyReadableTV.setText("Readable");
            } else {
            ...
            if (BlePeripheral.isCharacteristicWritable(characteristic)) {
                ...
                characteristicListItemView.mPropertyWritableTV.setText("Writeable");
            } else {
            ...
            if (BlePeripheral.isCharacteristicNotifiable(characteristic)) {
                ...
                characteristicListItemView.mPropertyNotifiableTV.setText("Notifiable");
            } else {
                characteristicListItemView.mPropertyNotifiableTV.setVisibility(View.GONE);
            }
            if (!BlePeripheral.isCharacteristicNotifiable(characteristic) && !BlePeripheral.isCharacteristicWritable(characteristic) && !BlePeripheral.isCharacteristicReadable(characteristic)) {
                characteristicListItemView.mPropertyNoneTV.setVisibility(View.VISIBLE);
                characteristicListItemView.mPropertyNoneTV.setText("None");
            } else {
